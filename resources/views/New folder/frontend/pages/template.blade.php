...
<html lang="en-US">
	...
	<body>
				...
				<div class="me-picture text-center animate_fade_in">
					...
					<div class="item">
						...
						<span class="socials animated bounceIn">
							...
							<a target="_blank" href="#" class="social fa fa-twitter"></a>
							<a target="_blank" href="#" class="social fa fa-google-plus"></a>
						</span>

						<!-- image -->
						<img class="img-responsive" src="{{asset('frontend')}}/images/preview/content/people/1.jpg" width="200" height="200" alt="" />
					...
					<div class="item">
						...
						<!-- image -->
						<img class="img-responsive" src="{{asset('frontend')}}/images/preview/content/people/2.jpg" width="200" height="200" alt="" />
					...
					<div class="item">
						...
						<!-- image -->
						<img class="img-responsive" src="{{asset('frontend')}}/images/preview/content/people/3.jpg" width="200" height="200" alt="" />
		...
		<section id="services">
			...
			<!-- service 1 -->
			<article id="service-1" class="container service-desc animate_fade_in">
				<div class="row">
					<div class="col-xs-12 col-md-3 text-left">
						<h3><i class="yellow fa fa-stop"></i> Corporate Identity</h3>
					</div>
			...
			<!-- service 2 -->
			<article id="service-2" class="container service-desc animate_fade_in">
				<div class="row">
					<div class="col-xs-12 col-md-3 text-left">
						<h3><i class="orange fa fa-stop"></i> Graphic Design</h3>
					</div>
					<div class="col-xs-6 col-md-6 text-left">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed, dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa.</p>
					</div>
			...
			<!-- service 3 -->
			<article id="service-3" class="container service-desc animate_fade_in">
				<div class="row">
					<div class="col-xs-12 col-md-3 text-left">
						<h3><i class="mauve fa fa-stop"></i> Development</h3>
					</div>
					<div class="col-xs-12 col-md-9 text-left">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed, dignissim pretium nunc. Nam et lacus neque. Etiam suscipit nisl eget lorem pellentesque quis iaculis mi mattis.</p>
					</div>
				</div>
			</article>

			<!-- service 4 -->
			<article id="service-4" class="container service-desc animate_fade_in">
				<div class="row">
					<div class="col-xs-12 col-md-3 text-left">
						<h3><i class="green fa fa-stop"></i> Video</h3>
					</div>
					<div class="col-xs-6 col-md-3 text-left">
						<ul>
							<li>2D &amp; 3D Animation</li>
						...
						<div class="col-md-4 quick-hover">
							<div class="quick-item">
								<div class="media-preview"><!-- video -->
									<iframe src="https://player.vimeo.com/video/24569304?title=0&amp;byline=0&amp;portrait=0" width="360" height="200"></iframe>
								</div>
						...
						<div class="col-md-4 quick-hover">
							<div class="quick-item">
								<div class="media-preview"><!-- audio -->
									<iframe class="fullwidth" height="200" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/248496843&amp;color=7E8344&amp;auto_play=false&amp;show_artwork=false"></iframe>
								</div>
