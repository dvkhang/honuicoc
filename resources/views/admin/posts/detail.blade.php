@extends('admin.templates.default', ['title'=>'Product Dettail',
                            ...
                            @if(!$product->addon->isEmpty())
                                <div class="body">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-3">
                                            <ul class="list-group">
                                                <li class="list-group-item"><img src="{{isset($item->getMedia()[0])==true?asset($item->getMedia()[0]->getUrl()):asset('addon.jpg')}}" class="img-responsive" style="width: 100%;" alt=""></li>
