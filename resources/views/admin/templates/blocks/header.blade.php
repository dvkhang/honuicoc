...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Quản lý - Hồ Núi Cốc</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li><a href="{{url('admin/user/profile')}}"><i class="material-icons">person</i>Profile</a></li>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2016 <a href="javascript:void(0);">Lê Trung Dũng</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
